...
#define ERR_CONN_RDFAIL         4
#define ERR_CONN_WFAIL          5
#define ERR_CONN_ZOOKEEPER      6
#define ERR_CONN_NOHSHAKE       7
#define ERR_CONN_ZKFAIL         8
#define ERR_CONN_ZKTIMOUT       9
#define ERR_CONN_ZKERR          10
#define ERR_CONN_ZKDBITERR      11
#define ERR_CONN_ZKNODBIT       12
#define ERR_CONN_ZKNOAUTH       13
#define ERR_CONN_ZKEXP          14
#define ERR_CONN_MAX            14
